...
export default function MultiplayerLobbyWebScreen() {
  ...
  const modes: {
  ...
  }[] = [
    {
      ...
      description: 'Same puzzle for both. Score multi-color odd palindromes before time runs out—highest score wins.',
      icon: 'flash',
    ...
    },
    {
      ...
      description: 'Chess-clock style! 5 minutes each. Score multi-color odd palindromes, outsmart your opponent.',
